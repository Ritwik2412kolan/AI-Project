...
def sendmail():
    ...
    gmail_list.append("20131a05n3@gvpce.ac.in")
...
class streaming(object):
    def __init__(self):
        ...
        self.video_capture = cv2.VideoCapture("/Users/shannu/Downloads/OSDHack-22_AccidentDetectionAI-main/WhatsApp Video 2024-11-14 at 00.00.39.mp4")
        self.model1 = torch.hub.load('ultralytics/yolov5', 'custom', path='/Users/shannu/Downloads/OSDHack-22_AccidentDetectionAI-main/best (2).pt', device='cpu')
        self.model = torch.hub.load('ultralytics/yolov5', 'custom', path='/Users/shannu/Downloads/OSDHack-22_AccidentDetectionAI-main/accident2.pt', device='cpu')
